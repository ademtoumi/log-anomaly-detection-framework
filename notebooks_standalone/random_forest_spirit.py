# =============================================================================
# STANDALONE NOTEBOOK â€” Random Forest on Spirit (Fully Independent)
#
...
# âœ… Chunked CSV reading â€” Spirit is large (~10M+ rows).
#
# Kaggle setup:
...
BASE_OUT = '/kaggle/working'               if KAGGLE else 'result/results_random_forest_spirit'
...
# Safety cap for Spirit â€” reduce to e.g. 3_000_000 if Kaggle OOM (16 GB RAM).
...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# CELL 2 â€” Load Spirit (chunked) + Build TF-IDF Splits Inline
...
if 'data_ready' not in ckpt:
    ...
    # Chunked load â€” Spirit is large; collect only what we need
    all_templates = []
    all_labels    = []
    rows_loaded   = 0
    ...
    print("[CELL 2] â­ï¸  Re-loading from saved TF-IDF vectorizer ...")
...
if 'rf_done' not in ckpt:
    ...
    print(f"\n  ðŸ“Š TEST RESULTS â€” Spirit Random Forest:")
    ...
    ax.set_title('RF CM â€” Spirit (Optimized)', fontweight='bold')
    plt.tight_layout()
    ...
    plt.title('RF ROC â€” Spirit (Optimized)', fontweight='bold')
    ...
    ax.set_title(f'RF Feature Importance â€” Spirit Top-{top_n}', fontweight='bold')
    ...
    try:
        ...
        plt.title('SHAP Summary â€” RF Spirit (Anomaly class)', fontweight='bold')
        plt.tight_layout()
    ...
    print(f"\n  âœ… RF Spirit done in {time.time()-t0:.0f}s")
else:
...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
print(f"\n{'='*60}")
print("  âœ… RF SPIRIT STANDALONE â€” COMPLETE")
print(f"{'='*60}")
...
for fname in ['rf_spirit_results.csv', 'rf_cm_spirit.png',
    ...
    p = f'{REPORT}/{fname}'
    print(f"  {'âœ…' if os.path.exists(p) else 'âŒ'} {fname}")
print(f"  ðŸ“Š Results â†’ {REPORT}/rf_spirit_results.csv")
