# =============================================================================
# STANDALONE NOTEBOOK — SVM on BGL (Fully Independent)
#
# Based on [Bekkouche2024] — Sequential split gives honest SVM performance.
# Based on [Bekkouche2025_Spirit] — class_weight='balanced' effective for logs.
...
if 'svm_done' not in ckpt:
    ...
    ax.set_title('SVM CM — BGL (Optimized)', fontweight='bold')
    plt.tight_layout()
    ...
    plt.title('SVM ROC — BGL (Optimized)', fontweight='bold')
    ...
    try:
        ...
        plt.title("SHAP Summary — SVM BGL (TF-IDF)", fontweight="bold")
        plt.tight_layout()
    ...
    print(f"\n  ✅ SVM BGL done in {time.time()-t0:.0f}s")
else:
...
# ─────────────────────────────────────────────────────────────────────────────
print(f"\n{'='*60}")
print("  ✅ SVM BGL STANDALONE — COMPLETE")
print(f"{'='*60}")
...
print(f"  📊 Results → {REPORT}/svm_bgl_results.csv")
